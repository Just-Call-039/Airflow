def temp_table():
    ...
    sql_insert = '''insert into suitecrm_robot_ch.contacts_temp
                    ...
                    from (select id,
                                ...
                                case when (base_source_c like '%^60^%' or base_source_c like '%^61^%' or base_source_c like '%^62^%') and base_source_c not like '%^52^%' then 1 else 0 end alive
