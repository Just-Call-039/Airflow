def region_editer(path_to_files, requests, path_result, file_result_req,file_result):
 ...
 print('count transfer 9287 dialog', transferfull[transferfull['datecalls'] > '2024-09-01'].groupby('dialog')['phone'].count()[9287.0])
 print('count transfer 9278 dialog', transferfull[transferfull['datecalls'] > '2024-09-01'].groupby('dialog')['phone'].count()[9278.0])
...
#                            right_on=['phone', 'datecalls', 'hoursonly', 'destination_queue'])
 ...
 print('count calls 9287 dialog', calltransfer[calltransfer['datecall'] > '2024-09-01'].groupby('dialog')['phone'].count()['9287'])
 print('count calls 9278 dialog', calltransfer[calltransfer['datecall'] > '2024-09-01'].groupby('dialog')['phone'].count()['9278'])
