select userid,
                           dateentered + interval 3 hour dateentered,
                           phone,
                           statused,
                           queue,
                           regions
                    from (select 
                    jc_meetings_beeline.assigned_user_id   userid,
                                 jc_meetings_beeline.status             statused,
                                 jc_meetings_beeline.date_entered dateentered,
                          ...
                          select jc_meetings_mts.assigned_user_id      userid,
                                ...
                                jc_meetings_mts.date_entered    dateentered,
                          ...
                          select jc_meetings_rostelecom.assigned_user_id     userid,
                                 ...
                                 jc_meetings_rostelecom.date_entered   dateentered,
                          ...
                          select jc_meetings_ttk.assigned_user_id      userid,
                                 ...
                                 jc_meetings_ttk.date_entered    dateentered,
                          ...
                          select jc_meetings_domru.assigned_user_id    userid,
                                 ...
                                 jc_meetings_domru.date_entered  dateentered,
                          ...
                          select jc_meetings_netbynet.assigned_user_id   userid,
                                 ...
                                 jc_meetings_netbynet.date_entered dateentered,
                        ...
                        select jc_meetings_other.assigned_user_id   userid,
                                 jc_meetings_other.status             statused,
                                 jc_meetings_other.date_entered dateentered,
                                 if(length(replace(replace(replace(replace(jc_meetings_other.phone_work, '-', ''), ')', ''), '(', ''),
                                                   ' ',
                                                   '')) <=
                                    10,
                                    concat(8,
                                           replace(replace(replace(replace(jc_meetings_other.phone_work, '-', ''), ')', ''), '(', ''),
                                                   ' ', '')),
                                    concat(8,
                                           right(replace(replace(replace(replace(jc_meetings_other.phone_work, '-', ''), ')', ''), '(',
                                                                 ''), ' ',
                                                         ''), 10))) as   phone,
                                 jc_meetings_other_cstm.last_queue_c  queue,
                                 '' as regions
                          from suitecrm.jc_meetings_other
                                   left join suitecrm.jc_meetings_other_cstm on id = id_c
                                   left join suitecrm.users on users.id = assigned_user_id
                          where date(jc_meetings_other.date_entered) >= '2024-01-01')#Other
