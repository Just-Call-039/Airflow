def data_transformation(file_from_sql,name_csv, files_to_csv):
    import pandas as pd
    ...
    # print(folder[n])
    print(file_from_sql)
    chunk = pd.read_csv(file_from_sql, sep=',')
    rows = chunk.shape[0]
