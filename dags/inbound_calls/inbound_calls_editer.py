def inbound_editer(path_to_files, inbound, operator_calls, request, path_result, file_result):
    ...
    calls_in = pd.read_csv(f'{path_to_files}/{inbound}').fillna('')
    ...
    calls_in_last = calls_in_last[['contact_id', 'asterisk_caller_id_c', 'calldate', 'assigned_user_id', 'result_call_c', 'otkaz_c', 'ne_reshena_c','reshena_c', 'operatorcalldate', 'operator','operatorqueue','operatorresultcall']]
    ...
    calls_in_last_rn = calls_in_last_rn[['contact_id','asterisk_caller_id_c', 'calldate', 'assigned_user_id',
    ...
    calls_phones = calls_in_last_rnr[['contact_id','asterisk_caller_id_c', 'calldate',
                                            # 'assigned_user_id_x',
                                            'assigned_user_id',
   'result_call_c', 'otkaz_c', 'ne_reshena_c', 'reshena_c',
...
#    ,'assigned_user_id_x': 'assigned_user_id'
    ...
    calls_in_last_rnr = calls_in_last_rnr[['contact_id', 'calldate',
                                            # 'assigned_user_id_x',
                                            'assigned_user_id',
   'result_call_c', 'otkaz_c', 'ne_reshena_c', 'reshena_c',
   'first_calldate', 'first_queue', 'operator','operatorresultcall','project', 'final_project','last_queue_c', 'date_entered', 'status', 'konva']].rename(columns={'final_project': 'request_project',
