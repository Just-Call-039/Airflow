def to_click(path_file, calls):
    ...
    try:
        ...
        client.execute('truncate table suitecrm_robot_ch.pokazateli_operatorov_today')
    except (ValueError):
        ...
        try:
            ...
            sql_create = '''create table if not exists suitecrm_robot_ch.pokazateli_operatorov_today
                    (
                        id            String,
                        call_date     Date,
                        name          String,
