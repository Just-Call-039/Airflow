...
import pandas as pd
import route_robotlogs_arhiv.all_functions as func
from route_robotlogs_arhiv.sql_query import sql_query_to_csv
import numpy as np
...
def group_log(path_project_folder, path_sql_log, path_sql_dest, path_sql_city, path_to_robot_log, path_to_route_unique, path_to_route,
    ...
    for i in range(1, count):
        ...
        date_f = datetime.strptime("2024-07-14", "%Y-%m-%d").date() - pd.Timedelta(days=i)
